 ...
 */
final class Version20180825093222 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_536FA40FF46CD258');
        $this->addSql('DROP INDEX IDX_536FA40FE455FCC0');
        $this->addSql('CREATE TEMPORARY TABLE __temp__matiere_enseignant AS SELECT matiere_id, enseignant_id FROM matiere_enseignant');
        $this->addSql('DROP TABLE matiere_enseignant');
        $this->addSql('CREATE TABLE matiere_enseignant (matiere_id INTEGER NOT NULL, enseignant_id INTEGER NOT NULL, PRIMARY KEY(matiere_id, enseignant_id), CONSTRAINT FK_536FA40FF46CD258 FOREIGN KEY (matiere_id) REFERENCES matiere (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_536FA40FE455FCC0 FOREIGN KEY (enseignant_id) REFERENCES enseignant (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO matiere_enseignant (matiere_id, enseignant_id) SELECT matiere_id, enseignant_id FROM __temp__matiere_enseignant');
        $this->addSql('DROP TABLE __temp__matiere_enseignant');
        ...
        $this->addSql('DROP INDEX UNIQ_4B98C2173A201E5');
        $this->addSql('CREATE TEMPORARY TABLE __temp__groupe AS SELECT id, promotion_id, createur_id, nom, description, taille FROM groupe');
        $this->addSql('DROP TABLE groupe');
        $this->addSql('CREATE TABLE groupe (id INTEGER NOT NULL, promotion_id INTEGER DEFAULT NULL, createur_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, taille INTEGER NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_4B98C21139DF194 FOREIGN KEY (promotion_id) REFERENCES promotion (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4B98C2173A201E5 FOREIGN KEY (createur_id) REFERENCES etudiant (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO groupe (id, promotion_id, createur_id, nom, description, taille) SELECT id, promotion_id, createur_id, nom, description, taille FROM __temp__groupe');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__etudiant AS SELECT id, promotion_id, bac_id, groupe_id, voeu_principal_id, voeu_secondaire_id, code_nip, nom, prenom, classement, username, moyenne FROM etudiant');
        $this->addSql('DROP TABLE etudiant');
        $this->addSql('CREATE TABLE etudiant (id INTEGER NOT NULL, promotion_id INTEGER DEFAULT NULL, bac_id INTEGER DEFAULT NULL, groupe_id INTEGER DEFAULT NULL, voeu_principal_id INTEGER DEFAULT NULL, voeu_secondaire_id INTEGER DEFAULT NULL, code_nip VARCHAR(255) NOT NULL COLLATE BINARY, nom VARCHAR(255) NOT NULL COLLATE BINARY, prenom VARCHAR(255) NOT NULL COLLATE BINARY, username VARCHAR(255) NOT NULL COLLATE BINARY, moyenne DOUBLE PRECISION DEFAULT NULL, classement VARCHAR(16) DEFAULT NULL, commentaire CLOB DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_717E22E3139DF194 FOREIGN KEY (promotion_id) REFERENCES promotion (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_717E22E3E03F15C0 FOREIGN KEY (bac_id) REFERENCES bac (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_717E22E37A45358C FOREIGN KEY (groupe_id) REFERENCES groupe (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_717E22E3B0D610FE FOREIGN KEY (voeu_principal_id) REFERENCES matiere (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_717E22E398F12918 FOREIGN KEY (voeu_secondaire_id) REFERENCES matiere (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO etudiant (id, promotion_id, bac_id, groupe_id, voeu_principal_id, voeu_secondaire_id, code_nip, nom, prenom, classement, username, moyenne) SELECT id, promotion_id, bac_id, groupe_id, voeu_principal_id, voeu_secondaire_id, code_nip, nom, prenom, classement, username, moyenne FROM __temp__etudiant');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__etudiant AS SELECT id, promotion_id, bac_id, groupe_id, voeu_principal_id, voeu_secondaire_id, code_nip, nom, prenom, classement, username, moyenne FROM etudiant');
        $this->addSql('DROP TABLE etudiant');
        $this->addSql('CREATE TABLE etudiant (id INTEGER NOT NULL, promotion_id INTEGER DEFAULT NULL, bac_id INTEGER DEFAULT NULL, groupe_id INTEGER DEFAULT NULL, voeu_principal_id INTEGER DEFAULT NULL, voeu_secondaire_id INTEGER DEFAULT NULL, code_nip VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, moyenne DOUBLE PRECISION DEFAULT NULL, classement INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO etudiant (id, promotion_id, bac_id, groupe_id, voeu_principal_id, voeu_secondaire_id, code_nip, nom, prenom, classement, username, moyenne) SELECT id, promotion_id, bac_id, groupe_id, voeu_principal_id, voeu_secondaire_id, code_nip, nom, prenom, classement, username, moyenne FROM __temp__etudiant');
        $this->addSql('DROP TABLE __temp__etudiant');
        $this->addSql('CREATE INDEX IDX_717E22E3139DF194 ON etudiant (promotion_id)');
        $this->addSql('CREATE INDEX IDX_717E22E3E03F15C0 ON etudiant (bac_id)');

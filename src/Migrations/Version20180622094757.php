 ...
 */
final class Version20180622094757 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_33D1A024F46CD258');
        $this->addSql('DROP INDEX IDX_33D1A024E455FCC0');
        $this->addSql('CREATE TEMPORARY TABLE __temp__enseignant_matiere AS SELECT enseignant_id, matiere_id FROM enseignant_matiere');
        $this->addSql('DROP TABLE enseignant_matiere');
        $this->addSql('CREATE TABLE enseignant_matiere (enseignant_id INTEGER NOT NULL, matiere_id INTEGER NOT NULL, PRIMARY KEY(enseignant_id, matiere_id), CONSTRAINT FK_33D1A024E455FCC0 FOREIGN KEY (enseignant_id) REFERENCES enseignant (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_33D1A024F46CD258 FOREIGN KEY (matiere_id) REFERENCES matiere (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO enseignant_matiere (enseignant_id, matiere_id) SELECT enseignant_id, matiere_id FROM __temp__enseignant_matiere');
        $this->addSql('DROP TABLE __temp__enseignant_matiere');
